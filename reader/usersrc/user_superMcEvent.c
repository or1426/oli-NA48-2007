...
int user_superMcEvent(superBurst *sbur,superMcEvent *evt) {
  ...
  float minDeadCellDistance = FLT_MAX;
  ...
  if( (minDeadCellDistance < 2) && (cutWhichKilledEvent == SURVIVED) )
    {
...
#if MC_ENABLE_CRAZY_LKR_ACC_CUT
