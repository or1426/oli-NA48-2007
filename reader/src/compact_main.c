...
/*   char rundir[161];               /\* run directory*\/ */
  ...
  /* initialize gString */
  memset(gString,0,STRINGMAX*sizeof(char));
...
/*       } */
    ...
    if(strcmp(argv[i],"-string")==0){
      strncpy(gString,argv[++i],(STRINGMAX-1)*sizeof(char));
#ifdef COMPACT_F77
      memcpy(gstring_.gstring,gString,STRINGMAX*sizeof(char));
#endif		
      continue;
    }
#ifdef BFLAG
